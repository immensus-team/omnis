...
- §3.1 InboxRow preview rule: `"Draft: {first part of body}"` had been left in English while user-facing copy was Korean — a violation of the §8 microcopy table and the §9 QA checklist rule, so it was corrected to the Korean wording.
