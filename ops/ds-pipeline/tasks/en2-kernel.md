# English sweep 2 — shard en2-kernel

Worktree: /Users/logankim/AI-Workspaces/omnis.plan-en2-kernel (branch plan/en2-kernel). Per-branch DB: omnis_test_en2_kernel. Scope (only these paths): packages/kernel packages/db packages/protocol
