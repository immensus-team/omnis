...
Write your verdict to $WT/.omnis-review.json as strict JSON: {\"approved\": true|false, \"issues\": [\"file:line — what is wrong — how to fix\", ...], \"notes\": [\"...\"]} and print the same JSON as your final message. Do not modify any other file. NEVER merge, rebase, push, commit or delete branches — you only review and write the verdict file." --permission-mode bypassPermissions --strict-mcp-config --output-format json > "$LOG/$NAME-review-$a.json" 2> "$LOG/$NAME-review-$a.err"
