...
// US-A36: manual archive flips just threads.archived_at — if that column is not replicated,
// the desktop Inbox/Archived views never refresh (A3 §7).
describe("threads.archived_at replication (US-A36)", () => {
